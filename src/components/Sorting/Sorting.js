...
class Sorting extends Component {
  ...
  sortFunc = async (e) => {
    e.preventDefault()
    this.setState({ isSorting: true }) // 🔹 disable button
    ...
    if (this.state.method == 'Algorithms') {
      ...
      this.setState({ isSorting: false }) // re-enable if error
    } else {
      ...
      results.forEach((step, i) => {
        setTimeout(() => {
          this.setState({ arr: step })
          // 🔹 when last step is done, re-enable button
        ...
        <nav class='navbar navbar-expand-lg navbar-light bg-light'>
          ...
          <div class='collapse navbar-collapse' id='navbarSupportedContent'>
            <ul class='navbar-nav mr-auto'>
              ...
              <li class='nav-item '>
                <a class='nav-link' href='#' onClick={this.randomize}>
                  Randomize <span class='sr-only'>(current)</span>
                </a>
              </li>
